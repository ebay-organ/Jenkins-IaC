...
{
git credentialsId: 'c980f791-7892-4df5-bcf7-51e5ff33abc1', url: 'https://github.com/ebay-organ/maven-web-app.git'
...
stage('5.Tomcat DeployTomcat')
{

deploy adapters: [tomcat9(credentialsId: 'Tomcat_credential', path: '', url: 'http://3.236.146.26:7777')], contextPath: null, war: '**/maven-web-app.war'
}
